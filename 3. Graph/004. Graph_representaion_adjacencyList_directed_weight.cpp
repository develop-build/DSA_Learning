...
#define mpi           #include <bits/stdc++.h>
using namespace std;
...
/*
    Input:
    no. of vertices=5, no. of edges=6
    1 2
    1 3
    3 4
    2 4
...
// O(V+E)
// weighted Directed Graph representation in Adjacency list
void solve() {
    int n, m;
    cin >> n >> m;
    ...
    for (int i = 0; i < m; i++) {
        ...
        cin >> u >> v >> wt;
        // adj[u].push_back(v);
        // If Directed graph, edge wil be from one vertex to another vertex
...
// O(V+E)
// Directed Graph representation in Adjacency list
void solve() {
    int n, m;
    cin >> n >> m;
    // one-based indexing graph
